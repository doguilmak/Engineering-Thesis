...
plt.title("Founding Outlier Observations from EGM2008 Datas Using Mahalanobis Distance", fontsize=15)
plt.xlabel("Longitude")
plt.ylabel("Difference between ellipsoidal heights and normal heights with linear interpolation(m)", fontsize=8)
plt.savefig('plot_EGM2008.png', dpi=300, bbox_inches='tight')  # Saving plot as .png
plt.show()
