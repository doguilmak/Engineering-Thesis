...
plt.title("Support Vector Prediction EGM2008")
plt.xlabel('Number of the Values')
plt.ylabel('Geoid Height Anomaly as meter')
plt.show()
...
plt.xlabel('Number of the Values')
plt.ylabel('Geoid Height Anomaly as meter')
plt.title("Random Forest Regressor Prediction Values EGM2008")
plt.show()
...
plt.title('Desicion Tree EGM2008')
plt.xlabel('Number of the Values')
plt.ylabel('Geoid Height Anomaly as meter')
plt.show()
...
print(lin_reg.predict([[35.148]]))

print("\nPolinomal Regression(degree=2):")
print(lin_reg2.predict(poly_reg2.fit_transform([[35.148]])))

print("\nPolinomal Regression(degree=4):")
print(lin_reg4.predict(poly_reg4.fit_transform([[35.148]])))

print("\nDecision Tree:")
print(r_dt.predict([[35.148]]))

print("\nRVS Radial Bases Function:")
print(svr_reg.predict([[35.148]]))

print("\nRandom Forest:")
print(rf_reg.predict([[35.148]]))
