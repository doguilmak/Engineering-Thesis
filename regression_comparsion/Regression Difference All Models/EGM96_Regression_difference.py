...
# DataFrame Slice
y = datas.iloc[:, 4:5] # EGM96 interpolated difference
...
# Prints standard deviation, variance and mean of EGM96 height anomalies
...
plt.scatter(X, Y,color='blue', s=size)
plt.plot(x,lin_reg.predict(X), color = 'orange')
plt.title('Linear Regression EGM96 with Standard Deviation Lines')
plt.xlabel('Number of the Values')
plt.ylabel('Geoid Height Anomaly as meter')
sns.set_style("whitegrid")
...
print("Mean squared error: ", mean_squared_error(y, lin_reg.predict(X)))
...
plt.title('2nd Order Polynomial Regression EGM96 with Standard Deviation Lines')
plt.xlabel('Number of the Values')
plt.ylabel('Geoid Height Anomaly as meter')
sns.set_style("whitegrid")
plt.legend(["\u03C3 - Predicted Value", "\u03C3 + Predicted Value", 
...
plt.title('4th Order Polynomial Regression EGM96 with Standard Deviation Lines')
plt.xlabel('Number of the Values')
plt.ylabel('Geoid Height Anomaly as meter')
sns.set_style("whitegrid")
plt.legend(["\u03C3 - Predicted Value", "\u03C3 + Predicted Value", 
